...
/*
		...
		usort($events, 'compareByName');
*/
	
		$events_unique = array_values(array_unique($events_unique));
		sort ($events_unique);
		$cols = 0;
			...
			foreach ($events as $events_item) {
				...
				if ($events_item['name'] == $unique) {
					...
					if ($i == 1) {			
						...
						if ($cols % 2 == 0) { 
							$html .= '<div class="et_pb_column et_pb_column_1_2  et_pb_column_3 et_pb_css_mix_blend_mode_passthrough et-last-child">';
						} else {
					    ...
					    $html .= '<div class="et_pb_text et_pb_module et_pb_bg_layout_light et_pb_text_align_left  et_pb_text_2 et_pb_with_border type-title">';
				            $html .= '<div class="et_pb_text_inner">';
				               $html .= '<div class="column-title">';
				                  ...
				                  $html .= '<h4 class="see-all"><a href="'. site_url() . '/hbi-events/event-types?id=' . $events_item['term_id'] . '">(See All)</a></h4>';
				               $html .= '</div>';
				            $html .= '</div>';
				        $html .= '</div>';
					} 
					...
					if ($i <= 2) {
						...
						$html .= '<div class="et_pb_text et_pb_module et_pb_bg_layout_light et_pb_text_align_left  et_pb_text_3">';
				            $html .= '<div class="et_pb_text_inner">';
				               $html .= '<div class="landing-events-columns">';
				                              ...
				                              $html .= '<div class="et_pb_column et_pb_column_2_3 et-last-child">';
				                                 $html .= '<div class="et_pb_text et_pb_module et_pb_bg_layout_light et_pb_text_align_left">';
				                                    $html .= '<div class="et_pb_text_inner">';
				                                       ...
				                                       $html .= '<div class="subtitle" style="font-size:16px"><a class="name" href="'. $link . '" target="_blank">' . $subtitle .'</a></div>';
				                                       $html .= '<div class="excerpt">' . $excerpt . '</div>';
				                                       $html .= '<div class="links">';
				                                          $html .= '<div class="read-more"><a href="' . $link . '" target="_blank">REGISTER AND LEARN MORE ></a></div>';
				                                       $html .= '</div>';
