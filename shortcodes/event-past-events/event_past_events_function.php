...
<?php
	...
	function event_past_events_function() {		
		...
		$html .= '<div class="taxonomy-title">';
			$html .= '<a class="breadcrumb" href="'. site_url() . '">HOME</a> / <a class="breadcrumb" href="' . site_url() . '/hbi-for-everyone/">FOR EVERYONE</a> / <a class="breadcrumb" href="' . site_url() .'/hbi-events/">EVENTS</a> / <span class="breadcrumb-current">' . 'PAST EVENTS' . '</span>';
